...
static void emit_leafcheck(Value *typ, const std::string &msg, jl_codectx_t *ctx)
{
    ...
    emit_typecheck(mark_julia_type(typ, true, jl_any_type, ctx), (jl_value_t*)jl_datatype_type, msg, ctx);
    Value *isleaf;
    isleaf = builder.CreateConstInBoundsGEP2_32(emit_bitcast(typ, T_pint8), 0, offsetof(jl_datatype_t, isleaftype));
